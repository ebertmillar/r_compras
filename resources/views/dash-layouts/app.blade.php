        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active">
                ...
                <li class="nav-item">
                    ...
                    <div id="collapseMarket" class="collapse" aria-labelledby="headingMarket" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            <h6 class="collapse-header">Supermercados:</h6>
                            <a class="collapse-item" href="{{url('supermercado')}}">Lista de Supermercados</a>
                            <a class="collapse-item" href="{{url('supermercado/create')}}">Registrar</a>
                        </div>
                    </div>
                </li>
